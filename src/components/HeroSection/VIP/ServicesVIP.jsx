...
const ServicesVIP = ({language}) => {
  ...
  useEffect(() => {
    axios
      ...
      axios
      .get(`${BASE_URL}/vip-service-headings`)
      .then((res) => {
        // console.log("res.data", res?.data);
    ...
    <>
    {
      ...
      <>
        <div className="halaContainer">
          <div className="category-heading text-[16px]">{heading?.main_service_vip}</div>
          <div className="offer-heading">{heading?.main_service_vip_sub}</div>
      ...
      <>
        <div className="halaContainer">
          <div className="flex flex-col justify-center items-center gap-8">
            <div className="category-heading text-[24px]"> {heading?.main_service_vip_ar} </div>
            <div className="offer-heading">{heading?.main_service_vip_sub_ar}</div>
          </div>
          <div className="flex w-[90%] m-auto flex-col flex-wrap mb-[30px] gap-[50px] items-center justify-center mt-[50px] md:flex-col lg:flex-row">
